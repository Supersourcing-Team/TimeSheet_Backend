...
@router.get("/{tool_id}", response_model=dict, dependencies=[Depends(pm_and_am)])
...
@router.put("/{tool_id}", response_model=dict, dependencies=[Depends(pm_only)])
...
@router.delete("/{tool_id}", response_model=dict, dependencies=[Depends(pm_only)])
